...
def main():
    ...
    ground_truth_observations = np.load("data/panda_reacher/geometric.npz")["arr_0"]
    ...
    ground_truth_actions = np.load("data/panda_reacher/joint.npz")["arr_0"]
